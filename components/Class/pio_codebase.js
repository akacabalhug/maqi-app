    ...
    scanAndConnect() {
        this.manager.startDeviceScan(null, null, (error, device) => {
            ...
            if (device.name == 'CoE_198') {
                ...
                device.connect({requestMTU: 180}).then((device) => {
    ...
    render() {
        return (<View style={
            ...
            <Text style={
                ...
                this.state.server_data
            }</Text>
            <Text style={
                styles.info
            }> {
                this.state.server_long
            }</Text>
            <Text style={
                styles.info
            }> {
                this.state.server_lat
            }</Text>
            <Text style={
                styles.info
            }> {
